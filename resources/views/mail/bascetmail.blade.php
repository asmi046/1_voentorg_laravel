...
<table style="width:100%; border-top:1px solid black; border-left:1px solid black; border-spacing: 0;">
    ...
    <tbody>
        @foreach ($formData['tovars'] as $item)
            <tr>
                <td style="padding: 5px; border-bottom:1px solid black; border-right:1px solid black;"><img width="70"
                        height="70" src="{{ asset($item['tovar_content']['img']) }}" alt=""></td>
                <td style="padding: 5px; border-bottom:1px solid black; border-right:1px solid black;">
                    {{ $item['tovar_content']['title'] }}<br />
                ...
                <td style="padding: 5px; border-bottom:1px solid black; border-right:1px solid black;">
                    {{ $item['quentity'] }}</td>
                <td style="padding: 5px; border-bottom:1px solid black; border-right:1px solid black;">
                    {{ (float) $item['quentity'] * (float) $item['price'] }} ₽</td>
            </tr>
        @endforeach
    </tbody>
</table>
