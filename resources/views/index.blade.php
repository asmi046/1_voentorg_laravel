...
@php
    $title = "Служивый46 - Тактическое снаряжение, берцы, Юнармия, ВКБО";
    $description = "Служивый46 тактическое снаряжение, форма ВКБО ВКПО, тактические костюмы, форма Юнармии, берцы (LOWA, Лова, Бизон), Горка, форменная одежда полиции, МЧС, кадетов.";
@endphp
